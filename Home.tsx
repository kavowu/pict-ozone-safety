...
export default function Home() {
  const reactChainImageUrl = '/manus-storage/pict-reaction-chain_8759f3cd.webp';
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-border">
        <div className="container flex items-center justify-between h-16">
          <a href="#summary" className="font-serif font-bold text-lg text-primary">
            WETOP / PICT
          </a>
          <div className="nav-links flex gap-6 items-center">
            <a href="#four-answers" className="text-sm hover:opacity-70 transition-opacity">四大答覆</a>
            <a href="#epa-response" className="text-sm hover:opacity-70 transition-opacity">EPA 對照</a>
            <a href="#no2" className="text-sm hover:opacity-70 transition-opacity">O₃ vs NO₂</a>
            <a href="#references" className="text-sm hover:opacity-70 transition-opacity">參考資料</a>
          </div>
        </div>
      </nav>

      {/* Hero Section */}
      <section id="summary" className="hero-section" style={{
        backgroundImage: `url(${reactChainImageUrl})`
      }}>
        <div className="hero-content">
          <div className="hero-copy">
            ...
            <div className="cta-buttons">
              <a href="#four-answers" className="cta-button">閱讀四大核心答覆</a>
              <a href="#epa-response" className="cta-button">查看 EPA 對照</a>
            </div>
          </div>
          <div className="hero-panel">
            <div className="label">Safety Thesis</div>
            <div className="thesis">可控 O₃｜No NO₂｜公開資料對照</div>
      ...
      <section className="metrics-band" aria-label="關鍵濃度概念">
        ...
        <div className="metric-block danger-metric">
          ...
          <div className="metric-label">WETOP 安全鐵律：避免生成</div>
        </div>
      </section>
      ...
      <section id="epa-response" className="split-section">
        ...
        <div className="issue-grid">
          <div className="issue-block">
            ...
            <h4>EPA 公開警示</h4>
            <p>
              臭氧產生器可能在有人室內環境造成過高臭氧濃度，且在不超過公共健康標準的濃度下，對部分污染物控制效果證據不足。
            </p>
          </div>
          <div className="issue-block">
            <div className="issue-tag">WETOP 回應</div>
            <h4>WETOP 專業答覆</h4>
            <p>
              PICT 不把高濃度臭氧作為唯一主力，而以光、離子、催化形成 AOP/ROS 連續反應鏈；臭氧是被量測與限制的中間因子，而非任意累積的除味手段。
            </p>
          </div>
          ...
          <div className="issue-block">
            ...
            <h4>WETOP 專業答覆</h4>
            <p>
              安全評估必須同時看 O₃ 與 NO₂/NOx；WETOP 將 NO₂ 列為不可接受副產物，並把『可控臭氧、避免 NO₂』視為比單純討論臭氧濃度更完整的安全底線。
            </p>
          </div>
          ...
          <div className="issue-block">
            ...
            <h4>WETOP 專業答覆</h4>
            <p>
              專業網站採用公開來源、濃度門檻、化學反應途徑與可檢測框架回答，而不是用『聞起來乾淨』作為安全證明。
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="image-text-section">
        <div>
          ...
          <p>
            使用者提供之技術聲明將 PICT 描述為 Photo-Ion-Catalysis Technology，屬高階氧化技術思維；其目的在於利用光解、離子化與觸媒催化形成多種短壽命淨化因子，而不是以高濃度臭氧單獨硬壓污染物。這也是 WETOP 可與 EPA 警示區分的核心：安全並非來自「沒有反應性物種」，而是來自反應物種的路徑、濃度與副產物控制。<sup>[1]</sup> <sup>[6]</sup>
          </p>
          <div className="reaction-concept">
            O₂ / H₂O + 光能 + 觸媒 → ROS / AOP 反應鏈 → 污染物化學鍵斷裂與降解
          </div>
        </div>
        <div>
          <img 
            src={reactChainImageUrl} 
            alt="PICT 光、離子、催化反應鏈示意"
          />
        </div>
      </section>
      ...
      <section id="references" className="content-section">
        ...
        <div className="reference-list">
          <div className="reference-item">
            ...
            <a href="https://www.epa.gov/indoor-air-quality-iaq/ozone-generators-are-sold-air-cleaners" target="_blank" rel="noopener noreferrer">
          ...
          <div className="reference-item">
            ...
            <a href="https://ww2.arb.ca.gov/resources/fact-sheets/californias-regulation-limit-ozone-emissions-indoor-air-cleaning-devices" target="_blank" rel="noopener noreferrer">
              https://ww2.arb.ca.gov/resources/fact-sheets/californias-regulation-limit-ozone-emissions-indoor-air-cleaning-devices
            </a>
          </div>
          ...
          <div className="reference-item">
            ...
            <a href="https://www.epa.gov/indoor-air-quality-iaq/nitrogen-dioxides-impact-indoor-air-quality" target="_blank" rel="noopener noreferrer">
          ...
          <div className="reference-item">
            ...
            <a href="https://www.epa.gov/ground-level-ozone-pollution/ground-level-ozone-basics" target="_blank" rel="noopener noreferrer">
          ...
          <div className="reference-item">
            ...
            <a href="https://aepromo.org/en/ozonotherapy-history/" target="_blank" rel="noopener noreferrer">
              https://aepromo.org/en/ozonotherapy-history/
            </a>
          </div>
